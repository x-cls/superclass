...
from .cls_model import Classifier
from .loss import ClipLoss, DistillClipLoss, CoCaLoss, SigLipLoss, ClsLoss
...
def create_model(
    ...
    if pretrained and pretrained.lower() == 'openai':
        ...
        is_cls_model = model_name.lower().startswith('cls-')

        if is_cls_model:
            model = Classifier(**model_cfg, cast_dtype=cast_dtype)
        else:
