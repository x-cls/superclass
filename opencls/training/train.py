...
def evaluate(model, data, epoch, args, tb_writer=None, tokenizer=None, step=None, should_zero_eval=False, should_val=False):
    metrics = {}
    ...
    zero_shot_metrics = zero_shot_eval(model, data, epoch, args, tokenizer=tokenizer, should_zero_eval=should_zero_eval)
